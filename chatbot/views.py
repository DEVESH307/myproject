        ...
        try:
            if current_card_id == 5 or current_card_id == 6:
                ...
                if payment_status_response.get('is_valid_company') or payment_status_response.get('is_valid_transaction'):
                    ...
                    print(payment_status_dataframe)
                    print(isinstance(payment_status_dataframe, pd.DataFrame))
                    if isinstance(payment_status_dataframe, pd.DataFrame):
                        ...
                        return JsonResponse({'bot_reply': {'status': 'error', 'message': payment_status_dataframe}}, status=400)
                else:
                    return JsonResponse({
